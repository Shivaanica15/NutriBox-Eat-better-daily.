...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         <span>Healthy Meals, Ready to Go</span>
         <h3>Eat Smarter with NutriBox Meal Subscriptions</h3>
         <p>Choose a plan that fits your goals and get balanced, chef-crafted meals delivered on schedule.</p>
         <a href="about.php" class="btn">Learn More About NutriBox</a>
      </div>
...
<section class="products">
   ...
   <h1 class="title">featured meal plans</h1>
   ...
   <form action="" class="box" method="POST">
      <div class="price">LKR <span><?= $fetch_plan["price"] ?></span>.00</div>
